...
var service_urls = require('./service_url_list'); 
...
function Twitter(options) {
	...
	this.oauth = new oauth.OAuth(this.options.request_token_url,
			this.options.access_token_url, this.options.consumer_key,
			this.options.consumer_secret, '1.0', null, 'HMAC-SHA1', null,
...
Twitter.prototype.get = function(url, params, callback) {
	console.log("CALLING_SERVICE:" + url);
	var originUrl = url;
...
//	console.log("TURACO_DEBUG - call " + url + "?" + querystring.stringify(params) + "\n \n");
	
	this.oauth.get(url + '?' + querystring.stringify(params),
			this.options.access_token_key, this.options.access_token_secret,
			function(error, data, response) {
				...
				if (error && error.statusCode) {
					var err = new Error('HTTP Error ' + originUrl + " -- " + error.statusCode + ': '
							+ http.STATUS_CODES[error.statusCode]);
					err.statusCode = error.statusCode;
					err.data = error.data;
//					console.log("TURACO_DEBUG - err: " + JSON.stringify(err));
...
Twitter.prototype.post = function(url, content, content_type, callback) {
	...
	this.oauth.post(url, this.options.access_token_key,
			this.options.access_token_secret, content, content_type, function(
					error, data, response) {
				if (error && error.statusCode) {
...
Twitter.prototype._getUsingCursor = function(url, params, callback) {
	var self = this, params = params || {}, key = params.key || null, result = [];
	...
	if (!key)
		callback(new Error(
				'FAIL: Results key must be provided to _getUsingCursor().'));
	delete params.key;
...
//List resources
Twitter.prototype.getListsSmall = function(uid, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	if (typeof uid === 'string')
		defaults.screen_name = uid;
	else
		defaults.user_id = uid;
	params = utils.merge(defaults, params);
	var url = service_urls.LIST_GET;
	this.get(url, params, callback);
	return this;
};

//List resources
Twitter.prototype.getLists = function(uid, params, callback) {
	var SUBSCRIPTIONS = 1;
	var OWNERSHIPS = 2;
	...
	var nResponses = 0;
	var lists = []; 
	function addResult(err, type, response){
		if (err) callback(err);
		
		if (type == SUBSCRIPTIONS || type == OWNERSHIPS){ // if needed we can split it.. 
			var _tmpArray = response.lists;
			lists.push.apply(lists, _tmpArray);
		}
		nResponses++;
		if (nResponses == 2){
			var tot = lists.length;
			console.log("TURACO_DEBUG - User " + uid + " No Lists: " + tot);
			callback(null, lists, tot);
		}
	}
	
	this.getListSubscriptions(uid, params, function(err, response, limit){
		console.log("TURACO_DEBUG - response getListSubscriptions");
		addResult(err, SUBSCRIPTIONS, response);
	});
	
	this.getListOwnerships(uid, params, function(err, response, limit){
		console.log("TURACO_DEBUG - response getListOwnerships");
		addResult(err, OWNERSHIPS, response);
	});
...
//List resources
Twitter.prototype.getListSubscriptions = function(uid, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	params = utils.merge(defaults, params);
	var url = service_urls.LIST_SUBSCRIPTINS_GET;
	this.get(url, params, callback);
	return this;
};

//List resources
Twitter.prototype.getListOwnerships = function(uid, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	params = utils.merge(defaults, params);
	var url = service_urls.LIST_OWNERSHIPS_GET;
	this.get(url, params, callback);
	return this;
};

Twitter.prototype.getList = function(params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	params = utils.merge(defaults, params);
	var url = service_urls.LIST_SHOW;
...
Twitter.prototype.createList = function(screen_name, list_name, params, callback) {
	...
	var url = service_urls.LIST_CREATE;
	params = utils.merge(params, {
		name : list_name
	});
	this.post(url, params, null, callback);
...
Twitter.prototype.updateList = function(screen_name, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	var url = service_urls.LIST_UPDATE;
	params = utils.merge(params, {
...
Twitter.prototype.deleteList = function(screen_name, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	var url = service_urls.LIST_DELETE;
	params = utils.merge(params, {
		user_name : screen_name
	});
	console.log("TURACO_DEBUG - params deleteList in : " + JSON.stringify(params));
	this.post(url, params, null, callback);
	return this;
 ...
 */
Twitter.prototype.subscribeme2List = function(params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	var url = service_urls.LIST_SUBSCRIBER_CREATE;
 ...
 * Subscribes the authenticated user to the specified list.
 */
Twitter.prototype.unsubscribeme2List = function(params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	var url = service_urls.LIST_SUBSCRIBER_DESTROY;
	this.post(url, params, callback);
	return this;
}
 ...
 */
Twitter.prototype.subscribe2List = function(list_id, uid, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	var url = service_urls.LIST_MEMBER_CREATE;
	this.post(url, params, callback);
	return this;
}
 ...
 */
Twitter.prototype.subscribeMemebers2List = function(list_id, uids, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	defaults.list_id = list_id;
	defaults.user_id = uids;
	params = utils.merge(defaults, params);
	
	var url = service_urls.LIST_MEMBER_CREATE_ALL;
	this.post(url, params, callback);
	return this;
}
 ...
 */
Twitter.prototype.destroyListMember = function(uid, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	var url = service_urls.LIST_MEMBER_DESTROY;
	this.post(url, params, callback);
	return this;
}
 ...
 */
Twitter.prototype.destroyListMembers = function(list_id, uids, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	var url = service_urls.LIST_MEMBER_DESTROY_ALL;
	this.post(url, params, callback);
	return this;
}
...
Twitter.prototype.getListMembers = function(list_id, params, callback) {
	...
	var url = service_urls.LIST_MEMBERS;
	this.get(url, params, callback);
	return this;
}

Twitter.prototype.getFriends = function(id, params, callback) {
	if (typeof params === 'function') {
		callback = params;
		params = null;
	}
	...
	var url = service_urls.FRIENDS_LIST;
	this.get(url, params, callback);
	return this;
}
...
Twitter.prototype.getListTimeline = function(params, callback) {
	var url = service_urls.LIST_STATUSES_GET;
	var defaults = {};
	defaults.list_id = list_id;
	params = utils.merge(defaults, params);
	this.get(url, params, callback);
...
Twitter.prototype.searchUser = function(q, params, callback) {
	...
	var url = service_urls.SEARCH_USERS;
	params = utils.merge(params, {q:q});
	this.get(url, params, callback);
	return this;
}
...
Twitter.prototype.getFriendsIds = function(id, params, callback) {
	...
	var url = service_urls.FRIENDS_IDS;
	this.get(url, params, callback);
	return this;
}


Twitter.prototype.showUser = function(id, pre_params, callback) {
	var url = service_urls.USER_LOOKUP;
	var params = {};
	var ids = [];
	var names = [];
	
	if (typeof pre_params === 'function') {
		callback = pre_params;
		pre_params = {};
	}
	...
	params = utils.merge(pre_params, params);
...
Twitter.prototype.getTrendsClosest = function(params, callback) {
	var pre_params = {};
	var url = service_urls.TRENDS_CLOSEST;
	params = utils.merge(pre_params, params);
	this.get(url, params, callback);
	return this;
}

Twitter.prototype.getTrendsPlace = function(params, callback) {
	var pre_params = {};
	if (params.id == null) 
		pre_params = {id : woeid};
	var url = service_urls.TRENDS_PLACE;
	params = utils.merge(pre_params, params);
	this.get(url, params, callback);
	return this;
}

Twitter.prototype.getTrendsAvailable = function(params, callback) {
	var pre_params = {};
	var url = service_urls.TRENDS_AVAILABLE;
	params = utils.merge(pre_params, params);
	this.get(url, params, callback);
	return this;
}

Twitter.prototype.getSavedSearches = function(params, callback) {
	var url = service_urls.SAVED_SEARCHES_LIST;
	this.get(url, params, callback);
	return this;
}
